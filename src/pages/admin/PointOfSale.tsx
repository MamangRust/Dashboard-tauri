  ...
  return (
    <div className="flex h-full overflow-hidden">
        ...
        <div className="p-6">
          ...
          <Breadcrumb className="mb-4">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/point-of-sale">
                  Point Of Sale
                </BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
      ...
      {isMobile ? (
        ...
        <aside className="w-80 bg-white dark:bg-[#0b1121] overflow-y-auto flex-shrink-0 border-l border-gray-200 dark:border-gray-700">
          <div className="p-6">
            <PurchaseHistory
              cart={cart}
              updateQuantity={updateQuantity}
